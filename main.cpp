...
void play(){
	...
	gotoxy(WIN_WIDTH + 5, 2);cout<<"FLYING BIRD";
...
//	play();
	...
	do{
		system("cls");
		gotoxy(10,5); cout<<" ±±±±±±±±±±±±±±±±±±±±±±±±±± ";
		gotoxy(10,6); cout<<" |      FLYING BIRD       | ";
		gotoxy(10,7); cout<<" ±±±±±±±±±±±±±±±±±±±±±±±±±± ";
		gotoxy(10,9); cout<<"I.   Start Game";
		gotoxy(10,10); cout<<"II.  Instructions";
		gotoxy(10,11); cout<<"III. Quit";
